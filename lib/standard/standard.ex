defmodule Simulator.Standard do
  @moduledoc """
  Distributed Simulator implemented using standard elixir structures.

  ## Look to "grid_0.txt", "grid_1.txt", ..., "grid_5.txt" files in lib/standard/grid_iterations
  """

  import Simulator.Standard.Position
  import Simulator.Standard.Printer

  alias Simulator.Standard.WorkerActor
